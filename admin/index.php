...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | ATMS</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'maintenance')? 'active' : '' ?>"" href="./?page=maintenance"><i class="fa fa-cogs"></i> Maintenance</a>
                    </li>
                    <?php endif; ?>
